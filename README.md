...
Скервис запущен под пользователем `root`, что недопустимо и черервато полным контролем над системой в случае его взлома. да и просто ошибка в сервисе может привести  кполомке всей системы.
...
* и т.п. В общем, я много узнал о настройках сервисов в работе над этим заданием, премного благодарен. 
...
Рекомендации:
Реализовать изоляцию сервиса с использованием встроенных механизмов systemd (sandboxing/hardening).
